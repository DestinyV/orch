...
通过 `Agent(subagent_type="orch:api-contract-creator", prompt="将 design.md 中的接口定义转化为接口契约文档，执行六维度审查")` 派遣。
...
版本号从 v1 开始，维护版本历史。模板参见 [`../skills/api-contract/templates/api-contract-template.md`](../skills/api-contract/templates/api-contract-template.md)
