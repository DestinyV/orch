...
```json
{
  ...
  "stages": {
    ...
    "code-design": { "status": "done|failed|skipped", "completed_at": "...", "tokens": { "input": 0, "output": 0, "total": 0 } },
    "api-contract": { "status": "done|failed|skipped|not_applicable", "completed_at": "...", "tokens": { "input": 0, "output": 0, "total": 0 } },
    "code-task": { "status": "done|failed|skipped", "completed_at": "...", "tokens": { "input": 0, "output": 0, "total": 0 } },
    "code-execute": { "status": "done|failed|skipped", "completed_at": "...", "tokens": { "input": 0, "output": 0, "total": 0, "agent_tokens": {} } },
    "code-test": { "status": "done|failed|skipped", "completed_at": "...", "tokens": { "input": 0, "output": 0, "total": 0 } },
    "spec-archive": { "status": "done|failed|skipped", "completed_at": "...", "tokens": { "input": 0, "output": 0, "total": 0 } }
  },
  "token_summary": {
    "total_input": 0,
    "total_output": 0,
...
效果评估数据，路径同上。模板见 `../workflow-control/templates/eval-template.json`。
