...
Agent(
  ...
  prompt="
    ...
    - 接口契约: spec-dev/{requirement_desc_abstract}/api-contract/api-contract.md（fullstack时）
...
模板见 `templates/diagrams/`，输出到 `spec-dev/{req_id}/tasks/diagrams/`。触发规则见 `../code-design/references/diagram-trigger-rules.md`。
