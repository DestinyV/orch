...
| 编码规范 | CLAUDE.md / CONTRIBUTING.md | code-execute 的代码生成规则 |
| 测试要求 | CLAUDE.md / CONTRIBUTING.md | test-design / code-execute 的覆盖率基线 |
| 目录约定 | README.md / ARCHITECTURE.md | code-execute 的文件创建路径 |
| API 约定 | ARCHITECTURE.md / docs | api-contract 的接口设计约束 |
| 技术栈 | package.json / pom.xml | code-design 的技术选型边界 |
